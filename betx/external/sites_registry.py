...
DEFAULT_SITES: list[SiteDefinition] = [
    ...
    SiteDefinition(
        ...
        parse_mode="generic_article",
        today_urls=["https://eaglepredict.com/fr/pronostics"],
        history_templates=[],
    ),
    SiteDefinition(
        slug="forebet",
    ...
    SiteDefinition(
        ...
        parse_mode="generic_listing",
        today_urls=["https://www.soccerpunter.com/predictions"],
        history_templates=["https://www.soccerpunter.com/predictions"],
    ),
    SiteDefinition(
        slug="soccervista",
        name="SoccerVista",
        ...
        parse_mode="generic_listing",
        today_urls=["https://www.soccervista.com/"],
        history_templates=["https://www.soccervista.com/"],
    ),
    SiteDefinition(
        slug="sportytrader",
        name="SportyTrader",
